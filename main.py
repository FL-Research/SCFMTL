...
from experiment import experiment_caltech101, experiment_tiny_imagenet
...
if __name__ == '__main__':
    ...
    if args.experiment == "performance-tiny-imagenet":
        print_info("Start experiment on tiny-imagenet")
        record = experiment_tiny_imagenet(args)
    ...
    np.save('log/simple_net/result/{}.npy'.format(args.filename), record)
